...
Set up the train and test set with the test set (wine-test) 10 percent of the data.
...
Build all the models on wines_mini to see if the complete and determine the best model to use for the final build.
```{r models-mini}
...
# Predict the poits in the test set
